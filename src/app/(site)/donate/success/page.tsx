    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="card-matrix p-8 max-w-md w-full text-center">
        <div className="mb-6 flex justify-center">
          <div className="w-20 h-20 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 flex items-center justify-center animate-pulse">
        ...
        <p className="text-primary/60 font-mono mb-6">
          // THANK YOU FOR SUPPORTING THE GLITCH
        </p>

        <p className="text-sm text-primary/40 mb-8">
          Your generosity helps us continue connecting people with free
          resources, grants, scholarships, and opportunities. Together, we're
          fixing the system.
        </p>
