...
const eligibilityCriteria = [
  {
    title: "Students",
    description:
      "Currently enrolled students at any level who need a computer for coursework and studies.",
    icon: GraduationCap,
  },
  {
    title: "Job Seekers",
    description:
      "Individuals actively searching for employment who need technology to apply for jobs.",
    icon: Briefcase,
  },
  {
    title: "Low-Income Families",
    description:
      "Families who cannot afford to purchase a computer for their household.",
    icon: Users,
  },
  {
    title: "Nonprofit Workers",
    description:
      "Staff at qualifying nonprofits who need equipment to serve their communities.",
    icon: Heart,
  },
];
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="max-w-3xl">
            <Badge className="mb-4 bg-teal-500/20 text-teal-700 hover:bg-teal-500/30">
              <Monitor className="h-3 w-3 mr-1" /> Apply Now
            </Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Get a Free Computer
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Technology should never be a barrier to opportunity. If you need a
              computer for school, work, or personal development, we may be able
              to help. Apply today.
            </p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {eligibilityCriteria.map((criteria) => (
            <Card key={criteria.title} className="text-center p-6">
              <criteria.icon className="h-12 w-12 mx-auto mb-4 text-primary" />
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 rounded-md border bg-background">
                  ...
                  <option>I have a computer but it&apos;s not working</option>
                </select>
              </div>
              <div>
                <label className="text-sm font-medium mb-2 block">
